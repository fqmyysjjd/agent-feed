...
| [`../../.agents/project/project-structure.md`](../../.agents/project/project-structure.md) | CLI wiring belongs in `src/agent_feed/cli.py`; Rich output helpers belong in `src/agent_feed/console.py`; generated template files belong under `src/agent_feed/templates/standard/`. |
